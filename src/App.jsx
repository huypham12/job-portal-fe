...
export default function App(){
  ...
  const displayName = profileMeta?.profile?.display_name || profileMeta?.profile?.full_name || user?.name || (role === 'recruiter' ? 'Nhà tuyển dụng' : 'Người tìm việc')
  ...
  return (
    <div>
          ...
          <div className="nav-actions">
            {role ? (
                  ...
                  {menuOpen && (
                    ...
                    >
                      <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                        ...
                        {role === 'recruiter' && (
                          <>
                          <button className="btn ghost" style={{ width: '100%', textAlign: 'left', justifyContent: 'flex-start' }} onClick={() => { setMenuOpen(false); navigate('/recruiter/candidate-recommendations') }}>
                            👥 Ứng viên đề xuất
                          </button>
                          </>
                        )}
              ...
              <>
                ...
                <NavLink className="btn primary" to="/login?role=recruiter&redirect=/post-job" style={{ whiteSpace: 'nowrap' }}>Đăng tin tuyển dụng</NavLink>
              </>
            )}
          </div>
        </div>
      ...
      <footer className="app-footer">
        <div className="container footer-grid">
          ...
          <div className="footer-col">
            ...
            <NavLink to="/login?role=recruiter&redirect=/post-job">Đăng tin tuyển dụng</NavLink>
      ...
      <SimpleModal open={confirmLogout} onClose={()=>setConfirmLogout(false)}>
