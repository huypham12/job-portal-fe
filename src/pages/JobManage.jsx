...
export default function JobManage() {
  ...
  // Load company data (job and stats are handled by the hook)
  useEffect(() => {
  ...
  return (
    <div className="section job-manage-page">
          ...
          {!editing && (
            <>
              ...
              {status === "draft" && (
                <Button
                  variant="primary"
                  onClick={() => confirmStatusChange("publish")}
                  icon={
                    <svg
                      width="16"
                      height="16"
            ...
            <div style={{ display: "grid", gap: "16px" }}>
              ...
              >
                ...
                <div>
                  ...
                  <p style={{ margin: "4px 0 0 0" }}>
                    {JOB_TYPE_OPTIONS.find((opt) => opt.value === job.job_type)
                      ?.label || job.job_type}
                  </p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p style={{ margin: "4px 0 0 0" }}>
                    {formatDisplayDate(job.expires_at)}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="job-stats-container">
              <div className="job-stats-grid">
                ...
                >
                  ...
                  <div className="stat-value">
                    {stats.total_views || stats.views_count || 0}
                  </div>
                ...
                >
                  ...
                  <div className="stat-value">
                    {stats.total_applications || stats.applications_count || 0}
                  </div>
              ...
              {stats.applications_by_status && (
                <div className="job-stats-breakdown">
                  <h3 className="stats-breakdown-title">
                    ...
                    {Object.entries(stats.applications_by_status).map(
                      ([status, count]) => (
                        <div key={status} className="stats-breakdown-item">
                          <span className="stats-breakdown-status">
                            {status}
                          </span>
      ...
      <ConfirmDialog
        ...
        message={
          pendingStatus === "publish"
            ? "Bạn có chắc chắn muốn gửi tin tuyển dụng này để admin duyệt? Tin sẽ được chuyển đến trạng thái chờ duyệt."
